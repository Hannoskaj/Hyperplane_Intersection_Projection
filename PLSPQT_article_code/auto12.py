...
for ss, ssl in [(1e12, '1e12')]:
    EG.generate_simulations(f'Jonas_experiment_7_qubits/vignette_7_qubits_{ssl}.h5', dim,
        ...
        depo_tol=1e-3, depo_rtol=1e-10, first_CP_threshold_least_ev=True, all_dists=False,
        keep_key_channels=False, keep_main_eigenvectors=2, save_intermediate=False, bigmem=True,
